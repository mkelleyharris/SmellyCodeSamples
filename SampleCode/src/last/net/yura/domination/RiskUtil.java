package last.net.yura.domination;
...
public class RiskUtil {
	...
	public static void printStackTrace(Throwable ex) {
		java.util.logging.Logger.getLogger(RiskUtil.class.getName()).log(
				java.util.logging.Level.WARNING, null, ex);
	}
	...
	public static void loadPlayers(Class uiclass) {
		...
		for (int cc = 1; cc <= RiskGame.MAX_PLAYERS; cc++) {
			...
			String name = "name"; // risk.getRiskConfig(nameKey);
			String color = "red"; // risk.getRiskConfig(colorKey);
			String type = "Human"; // risk.getRiskConfig(typeKey);
...
//			}
	...
	public static void savePlayers(Class uiclass) {
		...
		if (prefs != null) {
			...
			Vector players = new Vector();// risk.getGame().getPlayers();
