		...
		while(input != null) {
			...
			if (input.equals("") || input.charAt(0)==';') {
				...
				if (mode.equals("files")) {
					...
					// get translation
					String name = "neverneverland";// MapTranslator.getTranslatedMapName(id).replaceAll( "_", " ");
					...
					// get translation
					String name = "Canada"; //MapTranslator.getTranslatedMapName(id).replaceAll( "_", " ");
			...
			if (input.equals("") || input.charAt(0)==';') {
				...
				if (mode.equals("cards")) {
					...
					if (p!=null && !rawLoad) {
                                            ...
                                            java.util.ResourceBundle trans = java.util.ResourceBundle.getBundle("foobar"); //TranslationBundle.getBundle();
